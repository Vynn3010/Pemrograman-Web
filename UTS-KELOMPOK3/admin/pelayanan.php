...
$data = $conn->query("SELECT * FROM tbl_pelayanan ORDER BY id DESC");
...
<div class="main">
  ...
  <div class="card">
    ...
    <div class="info-box">
      Halaman CRUD untuk <strong><?= $page_title ?></strong> mengikuti pola yang sama dengan <a href="undangan.php" style="color:#2550c0;font-weight:700;">Jadwal Undangan</a> yang sudah lengkap. Data dari tabel <code><strong><?= "tbl_pelayanan" ?></strong></code> sudah siap di bawah. Silakan kembangkan form tambah/edit sesuai kebutuhan dengan referensi dari <code>undangan.php</code>.
    </div>
  </div>
  <div class="card">
