...
$data = $conn->query("SELECT * FROM tbl_pbb ORDER BY id DESC");
$page_title = "Pajak Bumi & Bangunan";
$page_icon  = "🏠";
?><!DOCTYPE html>
<html lang="id">
<head>
...
<div class="main">
  ...
  <div class="card">
    ...
    <div class="info-box">
      Halaman CRUD untuk <strong><?= $page_title ?></strong> mengikuti pola yang sama dengan <a href="undangan.php" style="color:#2550c0;font-weight:700;">Jadwal Undangan</a> yang sudah lengkap. Data dari tabel <code><strong><?= "tbl_pbb" ?></strong></code> sudah siap di bawah. Silakan kembangkan form tambah/edit sesuai kebutuhan dengan referensi dari <code>undangan.php</code>.
    </div>
  </div>
  <div class="card">
