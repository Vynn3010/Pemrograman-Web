...
$query = mysqli_query($koneksi, "SELECT * FROM tbl_apel ORDER BY tanggal ASC");
?>
...
<head>
  ...
  <title>Jadwal Apel — PAK CARIK Gandusari</title>
...
<div class="page-hero page-hero-apel">
  <div class="container">
    <div class="breadcrumb"><a href="../index.html">Beranda</a><span>/</span><span>Jadwal Apel</span></div>
    <h1>Jadwal Apel</h1>
    <p>Informasi jadwal pelaksanaan apel dan kegiatan internal Kecamatan Gandusari.</p>
  </div>
</div>
  ...
  <div class="container">
    <div class="panel">
      <div class="action-bar">
        <div><div class="section-badge">👥 Internal</div><h2 class="section-title" style="font-size:1.6rem;">Daftar Jadwal Apel</h2></div>
        <div style="display:flex;gap:10px;flex-wrap:wrap;align-items:center;">
          <div class="search-box"><span>🔍</span><input type="text" id="searchInput" placeholder="Cari jadwal..."></div>
          <button class="btn btn-blue btn-sm" onclick="printTable()">🖨️ Cetak</button>
        </div>
      </div>
      <div class="table-wrapper">
        <table id="tabelData">
          <thead><tr><th>No</th><th>Jenis Apel</th><th>Tanggal</th><th>Waktu</th><th>Lokasi</th><th>Pemimpin Apel</th><th>Keterangan</th><th>Status</th></tr></thead>
          <tbody>
<?php
$no = 1;
...
?>
  <tr>
    <td><?= $no++; ?></td>
    <td><?= $row['jenis_apel']; ?></td>
    <td><?= $row['tanggal']; ?></td>
    <td><?= $row['waktu']; ?></td>
    <td><?= $row['lokasi']; ?></td>
    <td><?= $row['pemimpin_apel']; ?></td>
...
?>
  <tr>
    <td colspan="8" style="text-align:center;padding:40px;color:var(--text-soft);">
      ...
      <strong>Belum ada data jadwal apel.</strong>
    </td>
  </tr>
<?php } ?>
</tbody>
