...
$query = mysqli_query($koneksi, "SELECT * FROM tbl_pelayanan ORDER BY tanggal_pengajuan ASC");
?>
...
<head>
  ...
  <title>Pelayanan (Perwalian & Legalisasi) — PAK CARIK Gandusari</title>
...
<div class="page-hero page-hero-pelayanan">
  <div class="container">
    <div class="breadcrumb"><a href="../index.html">Beranda</a><span>/</span><span>Pelayanan (Perwalian & Legalisasi)</span></div>
    <h1>Pelayanan (Perwalian & Legalisasi)</h1>
    <p>Layanan administrasi perwalian dan legalisasi dokumen sesuai ketentuan yang berlaku.</p>
  </div>
</div>
  ...
  <div class="container">
    <div class="panel">
      <div class="action-bar">
        <div><div class="section-badge">✅ Pelayanan</div><h2 class="section-title" style="font-size:1.6rem;">Data Pelayanan (Perwalian & Legalisasi)</h2></div>
      ...
      <div class="table-wrapper">
        <table id="tabelData">
          <thead><tr><th>No</th><th>Jenis Layanan</th><th>Nama Pemohon</th><th>NIK</th><th>Alamat</th><th>Keperluan</th><th>Tgl Pengajuan</th><th>Tgl Selesai</th><th>Status</th></tr></thead>
          <tbody>
<?php
$no = 1;
...
<tr>
  <td><?= $no++; ?></td>
  <td><?= ucwords(str_replace('_', ' ', $row['jenis_layanan'])); ?></td>
...
?>
  <tr>
    <td colspan="7" style="text-align:center;padding:40px;color:var(--text-soft);">
      ...
      <strong>Belum ada data pelayanan.</strong>
    </td>
  </tr>
<?php } ?>
</tbody>
