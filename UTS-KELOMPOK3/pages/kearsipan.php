...
$query = mysqli_query($koneksi, "SELECT * FROM tbl_arsip ORDER BY tanggal_dokumen ASC");
?>
...
<head>
  ...
  <title>Kearsipan — PAK CARIK Gandusari</title>
...
<div class="page-hero page-hero-arsip">
  <div class="container">
    <div class="breadcrumb"><a href="../index.html">Beranda</a><span>/</span><span>Kearsipan</span></div>
    <h1>Kearsipan</h1>
    <p>Layanan pengelolaan dan penyimpanan dokumen arsip secara tertata.</p>
  </div>
</div>
  ...
  <div class="container">
    <div class="panel">
      <div class="action-bar">
        <div><div class="section-badge">📁 Arsip</div><h2 class="section-title" style="font-size:1.6rem;">Data Kearsipan</h2></div>
      ...
      <div class="table-wrapper">
        <table id="tabelData">
          <thead><tr><th>No</th><th>No. Arsip</th><th>Judul Dokumen</th><th>Jenis Arsip</th><th>Tgl Dokumen</th><th>Pengirim</th><th>Penerima</th><th>Lokasi Simpan</th><th>Keterangan</th></tr></thead>
          <tbody>
<?php
$no = 1;
...
?>
  <tr>
    <td colspan="9" style="text-align:center;padding:40px;color:var(--text-soft);">
      ...
      <strong>Belum ada data arsip.</strong><br>
