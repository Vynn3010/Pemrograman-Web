...
$query = mysqli_query($koneksi, "SELECT * FROM tbl_ektp ORDER BY tanggal_pengajuan ASC");
?>
...
<head>
  ...
  <title>E-KTP — PAK CARIK Gandusari</title>
...
<div class="page-hero page-hero-ektp">
  <div class="container">
    <div class="breadcrumb"><a href="../index.html">Beranda</a><span>/</span><span>E-KTP</span></div>
    <h1>E-KTP</h1>
    <p>Layanan informasi dan pengurusan administrasi Kartu Tanda Penduduk Elektronik.</p>
  </div>
</div>
  ...
  <div class="container">
    <div class="panel">
      <div class="action-bar">
        <div><div class="section-badge">🪪 Adminduk</div><h2 class="section-title" style="font-size:1.6rem;">Data E-KTP</h2></div>
      ...
      <div class="table-wrapper">
        <table id="tabelData">
          <thead><tr><th>No</th><th>Nama</th><th>NIK</th><th>Alamat</th><th>Tgl Pengajuan</th><th>Tgl Selesai</th><th>Keterangan</th><th>Status</th></tr></thead>
<tbody>
<?php
$no = 1;
...
?>
  <tr>
    <td colspan="8" style="text-align:center;padding:40px;color:var(--text-soft);">
      ...
      <strong>Belum ada data E-KTP.</strong><br>
