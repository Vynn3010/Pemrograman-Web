...
$query = mysqli_query($koneksi, "SELECT * FROM tbl_sidang_waris ORDER BY tanggal_sidang ASC");
?>
...
<head>
  ...
  <title>Jadwal Sidang Waris — PAK CARIK Gandusari</title>
...
<div class="page-hero page-hero-waris">
  <div class="container">
    <div class="breadcrumb"><a href="../index.html">Beranda</a><span>/</span><span>Jadwal Sidang Waris</span></div>
    <h1>Jadwal Sidang Waris</h1>
    <p>Informasi jadwal pelaksanaan sidang waris sebagai layanan administrasi hukum masyarakat.</p>
  </div>
</div>
  ...
  <div class="container">
    <div class="panel">
      <div class="action-bar">
        <div><div class="section-badge">⚖️ Sidang</div><h2 class="section-title" style="font-size:1.6rem;">Data Jadwal Sidang Waris</h2></div>
      ...
      <div class="table-wrapper">
        <table id="tabelData">
          <thead><tr><th>No</th><th>Nama Pemohon</th><th>Tanggal Sidang</th><th>Waktu</th><th>No. Perkara</th><th>Keterangan</th><th>Status</th></tr></thead>
          <tbody>
<?php
$no = 1;
...
?>
  <tr>
    <td colspan="7" style="text-align:center;padding:40px;color:var(--text-soft);">
      ...
      <strong>Belum ada data sidang waris.</strong>
    </td>
  </tr>
<?php } ?>
</tbody>
